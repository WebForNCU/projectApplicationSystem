...
public interface TableTeachDao{
    ...
    Integer addTableTeach(Integer id,String table_teach_name,String table_name,String table_teacher_describe,String table_describe,Integer isfill,Integer audit,String src);
