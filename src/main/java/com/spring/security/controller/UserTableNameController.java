...
public class UserTableNameController {
    ...
    public String loginUsertableName(@PathVariable String username, @PathVariable String batch_name){
        ...
        tableName = tableNameDao.queryTableName(batchname);
         ...
         */
        tableTeach = tableTeachDao.queryTableTeachByTableNameAndUserName(tableName.getTable_name(),username);
...
//    }
    ...
    public String toupdateTableTeach(Model model){
        model.addAttribute("tablename",tableTeach.getTable_name());
        model.addAttribute("tableTeachs",tableTeachs);
        model.addAttribute("tableTeach",tableTeach);
    ...
    public String updateTableTeach(@RequestParam("file") MultipartFile uploadFile, Model model,HttpServletRequest request) {
        ...
        tableTeach = tableTeachDao.queryTableTeachByTableNameAndUserName(table_name,username);
